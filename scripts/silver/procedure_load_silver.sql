...
BEGIN
	...
	*,
	...
	SELECT
		prd_id,
		REPLACE(SUBSTRING(prd_key, 1, 5), '-', '_') AS cat_id, -- in order to join with another table
		SUBSTRING(prd_key, 7, LEN(prd_key)) AS prd_key, -- to join with sales detail table
		prd_nm,
